...
class IAAddRespect(CommandInterpreter):
    def __init__(self):
        super().__init__()
        # On autorise généralement à partir d'un certain niveau pour que l'IA gère les relations
        self.requiredRoleLevel = constantes.ROLE_LEVEL_VIEWER_ASSIDU
        self.activationCommand = "ADD_RESPECT"
    ...
    def execute(self, username, message, twSock, args=None):
        ...
        with get_session() as session:
            ...
            if user_affinity:
                # Calcul du nouveau score avec limite -100 / 100
